...
<html lang="en">
    ...
    <body class="employeesignin-page ">
 echo "<body style='background-color:black'>";
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">      
                            <span class="chapter-title">Online Leave Management </span>
                        </div>
          ...
          <div class="footer">
                    <p style="color:yellow;">Online Leave Management</p>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4 style="color:red;">Online Leave Management Software</h4></div>
