...
echo "<body style='background-color:black'>";
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">      
                            <span class="chapter-title">Online Leave Application</span>
                        </div>
          ...
          <div class="footer">
                    <p><strong>online leave management software</strong></p>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><i><h2 style="color:beige;">Employee Password Recovery</i></h2></div>
